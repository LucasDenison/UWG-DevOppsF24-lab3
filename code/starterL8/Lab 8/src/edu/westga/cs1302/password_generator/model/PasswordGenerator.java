...
public class PasswordGenerator {
	...
	/** Checks if the provided value is a valid length value.
	 * All length values must be positive.
	 * 
	 * @precondition none
	 * @postcondition none
	 * 
	 * @param length the length value to be checked
	 * @return true  if length value is valid
	 * 		   false if length value is not valid
	 */
